...
public class FeedBacks extends Activity {
    ...
    String cashCus,inputcustomer,inputname;
    Button btnfbsend;
    EditText edtmsg;
...
btnfbsend=(Button)findViewById ( R.id.fbsend );
        ...
        edtmsg=(EditText)findViewById ( R.id.edtfeedback );
        btnnam.setText("");
       ...
       SaveFeedBack (mydate,userid,msg,"sent","C");
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, final View v,
                ...
                AlertDialog.Builder builder2 = new AlertDialog.Builder(com.example.myshopapp.FeedBacks.this);
...
//                Toast.makeText(getApplicationContext(), "long press:" + selectedname, Toast.LENGTH_LONG).show();
    ...
    private void SaveFeedBack(final String mydate , final String userid , final String msg , final String sent , final String c) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, NetworkMonitor.FEEDBACKS_INSERT_URL,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
                                //Toast.makeText ( FeedBacks.this , ""+mydate+":"+userid+":"+msg+":"+sent+":"+c , Toast.LENGTH_SHORT ).show ( );

                                JSONObject jsonObject = new JSONObject(response);
                                if (!jsonObject.getBoolean("error")) {
                                    Toast.makeText ( FeedBacks.this , "Feed Back Sent successfully", Toast.LENGTH_SHORT ).show ( );
                                }else {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText ( getApplicationContext () , "volly error" , Toast.LENGTH_SHORT ).show ( );
                }
            })
            {
                @Override
                protected Map<String, String> getParams() {
                    ...
                    params.put("datetime", mydate);
                    params.put("customerid", userid );
                    params.put("detail", msg);
                    params.put("msgstatus", sent);
                    params.put("msgfrom", c);
                    return params;
                }
            };
...
//}
    ...
    private void GetDataFromServer(final String a) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, NetworkMonitor.FEEDBACKS_SERVER_DATA_URL ,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                String cusid =obj.getString("customerid");
                                String msg=obj.getString("detail");
                                String msgstatus = obj.getString("msgstatus");
                                String msgfrom = obj.getString("msgfrom");
                                String pass="";

                                if (cusid.equals(a)) {
                                    Toast.makeText(getApplicationContext(),"SENDER "+msgfrom,Toast.LENGTH_SHORT).show();
                                    if (msgfrom.equals("C")) {
                                        pass = pass + "you: \n";
                                    }
                                    else {
                                ...
                                //Toast.makeText ( getApplicationContext () , "call resevetable methode"+tableno , Toast.LENGTH_SHORT ).show ( );
                            }
