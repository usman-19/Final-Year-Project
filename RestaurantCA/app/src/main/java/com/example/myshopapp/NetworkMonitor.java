...
public class NetworkMonitor extends BroadcastReceiver {
    ...
    // i have remove public static final from all b
  // public static final String CUSTOMER_URL="http://192.168.43.36/MyShopAppApi/";
    public static final String CUSTOMER_URL="https://sohailapp.000webhostapp.com/Restaurant_App_API/";
    public static final String FEEDBACKS_INSERT_URL =CUSTOMER_URL+"addFeedBack.php";
    public static final String FEEDBACKS_SERVER_DATA_URL=CUSTOMER_URL+"feedbackGetServerData.php";
            ...
            if (cursorCus.moveToFirst()) {
               do {
                ...
                do {
                    ...
                    myStringDP.add( cursorItm.getString(cursorItm.getColumnIndex(db.D_CHARGES)));
