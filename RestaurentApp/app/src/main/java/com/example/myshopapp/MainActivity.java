...
import java.util.List;
        ...
        public class MainActivity extends Activity {
            Button btnItem,btnCus,btnSup,btnAccount,btnsetting,btnorders,btntable;
...
//Toast.makeText(getApplicationContext(),""+lang,Toast.LENGTH_SHORT).show();
                ...
                btntable.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i=new Intent(getApplicationContext(),Table_Record.class);
                        startActivity(i);
                    }
                });
            }
...
//makeText(getApplicationContext(),""+lang,Toast.LENGTH_SHORT).show();
